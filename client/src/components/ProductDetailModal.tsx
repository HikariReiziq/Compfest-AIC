      ...
      <div className="relative w-full max-w-2xl bg-surface-100 border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-surface-50/70 p-4 rounded-2xl border border-white/5 space-y-3 text-xs text-slate-300 leading-relaxed">
            ...
            <p>
              <strong className="text-rose-300">2. Proporsi Geometris:</strong> Potongan siluet produk ini dirancang untuk melengkapi bentuk wajah ({userProfile?.face_shape?.shape || "Oval"}) {userProfile?.gender?.label_id === "female"
                ? " dan gaya feminin Anda"
                : userProfile?.gender?.label_id === "male"
                  ? " dan gaya maskulin Anda"
